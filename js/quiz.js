...
const QUIZZES = {
    ...
    hanasajiki: {
        ...
        questions: [
            ...
            {
                question: '秋のあわじ花さじきを彩る代表的な花のひとつはどれ？',
                choices: [
                    'コスモス',
                    'チューリップ',
                    'アジサイ',
        ...
        questions: [
            {
                ...
                answer: 0,
                explanation:
                    '伊弉諾神宮では、国生み・神生みで知られるイザナギノオオカミとイザナミノオオカミをお祀りしています。',
                detailUrl: 'sightseeing.html#spot-03'
            },
            {
            ...
            {
                question: '伊弉諾神宮の境内にある「陽の道しるべ」は、主に何を表したもの？',
                choices: [
                    '淡路島の昔の海岸線',
                    '全国の有名な神社と太陽の運行との位置関係',
                    '淡路島を一周する街道',
                    '国生み神話に登場する島の大きさ'
                ],
                answer: 1,
                explanation:
                    '「陽の道しるべ」は、伊弉諾神宮を中心として、太陽が昇る・沈む方向などに位置する伊勢神宮や出雲大社などの神社との位置関係を示したモニュメントです。',
                detailUrl: 'sightseeing.html#spot-03'
            },
            {
                question: '伊弉諾神宮は、イザナギノオオカミが何をした場所に建てられたと伝えられている？',
                choices: [
                    '初めて海を渡った場所',
                    '余生を過ごした場所',
                    '初めて稲作を始めた場所',
                ...
                answer: 1,
                explanation:
                    '伊弉諾神宮は、国生み・神生みを終えたイザナギノオオカミが、淡路島の多賀の地に「幽宮（かくりのみや）」を構えて余生を過ごした場所と伝えられています。',
                detailUrl: 'sightseeing.html#spot-03'
            }
        ]
    },
    ...
    uzunooka: {
        ...
        questions: [
            {
                question: 'うずの丘 大鳴門橋記念館の有名な巨大オブジェは？',
                choices: [
                    '巨大レモン',
                    'おっ玉葱',
                    '巨大しいたけ',
            ...
            {
                question: '「おっ玉葱」と一緒に写真を撮るとき、背景に見える代表的な景色は？',
                choices: [
                    '大鳴門橋と鳴門海峡',
                    '明石城と六甲山',
                    '姫路城と瀬戸内海',
                ...
                answer: 0,
                explanation:
                    'おっ玉葱の向こうには、大鳴門橋と鳴門海峡の雄大な景色が広がります。',
                detailUrl: 'sightseeing.html#spot-04'
            },
            {
                question: '館内の「うずしお科学館」で楽しく学べるテーマは？',
                choices: [
                    '淡路島の鉄道史',
                    '鳴門海峡のうずしおの仕組み',
                    '宇宙開発',
            ...
            {
                question: 'うずしお科学館の「ウズネタリウム」で使われているものは？',
                choices: [
                    '実物大の潜水艦',
                    'うずしおを再現する水理模型',
                    '本物の台風を起こす装置',
            ...
            {
                question: '「おっ玉葱」での記念撮影をさらに楽しむため、貸し出されているものは？',
                choices: [
                    'たまねぎカツラ',
                    '渦潮柄の長靴',
                    '鳴門橋の模型帽子',
